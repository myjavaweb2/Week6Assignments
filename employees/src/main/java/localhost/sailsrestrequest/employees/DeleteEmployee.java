...
/**
 * This class will connect to the Sails database and get delete the employee records.
...
public class DeleteEmployee {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//This is the variable to hold the ID number of the employee to be deleted.
			String id = "15";
